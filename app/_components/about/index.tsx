...
//---
const AboutSection = () => {
  const fadeInBottom = { hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6 } } };
  const ref1 = React.useRef(null);
  const inView1 = useInView(ref1, { once: false, amount: 0.5 });
  return (
    <div className="bg-[#060405] bg-cover bg-center h-full flex flex-col items-center justify-center px-8 sm:px-12 md:px-16 lg:px-24 pt-12 pb-20 md:pb-32">
      <motion.div ref={ref1} initial="hidden" animate={inView1 ? "visible" : "hidden"} variants={fadeInBottom}>
        <div className="text-center mb-8 md:mb-10 lg:mb-12"><Image src="/images/about-top-img.png" alt="shap" width={1444} height={19} /></div>
      </motion.div>
      <div className="container mx-auto">
        ...
        <div className="text-2xl md:text-3xl lg:text-4xl text-white mt-6 md:mt-8 lg:mt-10">
          How does it work?
          ...
          to make faster decisions, unlock new opportunities, and achieve unprecedented value in a secure and cost-efficient
          way.
        </div>
      </div>
    </div>
