  ...
  return (
    ...
    >
      <div className="relative container mx-auto px-4 sm:px-8 flex items-center">
        ...
        <motion.div
          className="relative right-3 top-[50%] h-[2.5px] grow-1 bg-white hidden lg:block origin-left"
      ...
      <div className="relative container mx-auto px-4 sm:px-8 mt-12">
        ...
        <motion.div
          className='absolute right-1 top-0 h-[87%] w-[2px] bg-white hidden lg:block origin-top'
          variants={lineVariants}
          initial="initial"
          animate={isInView ? "animate" : "initial"}
        />
        <motion.div
          className='absolute right-1 top-[85%] h-[20px] w-[100px] border-r-3 border-b-3 rounded-br-xl hidden lg:block'
          variants={lineVariants}
          initial="initial"
          animate={isInView ? "animate" : "initial"}
        />
