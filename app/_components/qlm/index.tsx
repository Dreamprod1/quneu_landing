...
const QLMSection = () => {
  ...
  return (
    <div
      ...
      className="relative bg-[#0E0E0E] h-full pb-24 md:pb-36 -mt-2 text-white overflow-hidden"
    >
      <div className="relative w-full max-w-[78rem] px-6 mx-auto">
        <div className="relative flex items-center">
            <motion.h2
              className={`${anta.className} bg-[#0E0E0E] text-gray-100 
              text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-8xl tracking-widest`}
            ...
            <motion.div
              className="relative mr-10 h-[2.5px] grow-1 bg-white  origin-left 
              hidden lg:block"
            ...
            />
            <motion.div
              className='absolute right-6 top-[49%] h-[133px] w-[110px] border-r-3 border-t-3 rounded-tr-xl 
              hidden lg:block'
              variants={lineVariants}
              initial="initial"
              animate={isInView ? "animate" : "initial"}
      ...
      <motion.div
        className="h-[2px] bg-white -mx-8 my-2 md:my-4 origin-left"
        variants={lineVariants}
        initial="initial"
        animate={isInView ? "animate" : "initial"}
      ></motion.div>
        ...
        <div className="relative mt-9">
          <div className="lg:mr-28">
              ...
              >
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[1.45rem]">
          ...
          <motion.div
            className='absolute right-6 top-0 h-[87%] w-[2px] bg-white origin-top 
            hidden lg:block'
            variants={lineVariants}
            initial="initial"
            animate={isInView ? "animate" : "initial"}
          />
          <motion.div
            className='absolute right-6 top-[85%] h-[20px] w-[100px] border-r-3 border-b-3 rounded-br-xl 
            hidden lg:block'
            variants={lineVariants}
            initial="initial"
            animate={isInView ? "animate" : "initial"}
