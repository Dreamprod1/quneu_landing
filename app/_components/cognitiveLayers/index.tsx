...
const CognitiveLayers = () => {
  ...
  return (
    <div id="cognitive_layers" className="relative bg-[#EAEAEA] text-black overflow-hidden
      pt-12 md:pt-16
      pb-24 md:pb-28">
      <div className="relative w-full max-w-[83rem] px-6 mx-auto">
        <div>
          <h2 className={`${anta.className} font-bold mb-2 md:mb-4 lg:mb-6 text-3xl md:text-6xl lg:text-8xl tracking-tight`}>
            <HighlightedText delay={0} text={`COGNITIVE LAYERS`} /></h2>
          <h5 className="text-stroke-dark text-2xl md:text-5xl lg:text-6xl">
            <HighlightedText delay={0.5} text={`HOW Q0 THINKS`} /></h5>
          <p className="text-base md:text-lg lg:text-xl text-justify mt-4 md:mt-6 xl:w-3/4">
            <HighlightedText delay={1} text={`While your competitors wrestle with AI to update static ontology databases, Q0 operates on an entirely different principle. It doesn't just process your data—it cultivates living knowledge that grows stronger with every interaction. Q0's breakthrough architecture operates through four synchronized intelligence layers, each amplifying the others:`} /></p>
        </div>
        <Image src="/images/cognitiveplayer-right-shap1.png" alt="quen process" width={336} height={1001} className="hidden xl:block pointer-events-none absolute right-0 top-0" />
        <div className="flex flex-col gap-9 mt-10 md:mt-12 lg:mt-16">
          <div id="cognitive_layer_1" className='relative flex gap-4 items-center'>
            <motion.div ref={ref_box_1} initial="hidden" animate={inView_box_1 ? "visible" : "hidden"} variants={fadeInRight} className="flex flex-col gap-1 md:gap-3 border-2 rounded-3xl shadow-md bg-[url('/images/cognitive-layer-1.png')] bg-no-repeat bg-left-bottom
              px-4 lg:px-8 xl:px-10 pt-8 pb-12 lg:pb-16 xl:pb-20">
              <h3 className={`font-semibold ${anta.className}
              text-2xl md:text-3xl lg:text-4xl tracking-wide`}>LAYER 1: THE EXPLORER BRAIN</h3>
              <p className={`${anta.className}
              text-xl md:text-2xl lg:text-3xl tracking-tight`}>(Autonomous Discovery)</p>
            ...
            <div className='relative md:min-w-[18%] lg:min-w-[23%] xl:min-w-[41%] hidden md:block'>
              <div className='absolute border-t-2 border-r-2 rounded-tr-2xl h-[20px] top-[48%] right-0 md:w-[60%] lg:w-[75%] xl:w-[87%] ' />
              <svg className='mr-auto scale-[0.8]' width="78" height="78" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='absolute right-0 w-[2px] top-[53%] h-[50%] bg-black hidden md:block' />
          </div>
          <div id="cognitive_layer_2" className='relative flex gap-4 items-center'>
            <motion.div ref={ref_box_2} initial="hidden" animate={inView_box_2 ? "visible" : "hidden"} variants={fadeInRight} className="flex flex-col gap-1 md:gap-3 border-2 rounded-3xl shadow-md bg-[url('/images/cognitive-layer-2.png')] bg-no-repeat bg-left-bottom
              px-4 lg:px-8 xl:px-10 pt-8 pb-12 lg:pb-16 xl:pb-20">
              <h3 className={`font-semibold ${anta.className}
              text-2xl md:text-3xl lg:text-4xl tracking-wide`}>LAYER 2: THE INFINITY BRAIN</h3>
              <p className={`${anta.className}
              text-xl md:text-2xl lg:text-3xl tracking-tight`}>(Temporal Intelligence)</p>
              <div className='flex flex-col gap-4
              text-base md:text-lg lg:text-xl'>
            ...
            <div className='relative md:min-w-[18%] lg:min-w-[23%] xl:min-w-[41%] hidden md:block'>
              <div className='absolute border top-[48%] right-0 md:w-[60%] lg:w-[75%] xl:w-[87%] ' />
              <svg className='mr-auto scale-[0.8]' width="78" height="78" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="39" cy="39" r="37.75" stroke="black" strokeWidth="2.5" />
            ...
            <div className='absolute right-0 w-[2px] -top-[10%] h-[110%] bg-black hidden md:block' />
          </div>
          <div id="cognitive_layer_3" className='relative flex gap-4 items-center'>

            <motion.div ref={ref_box_3} initial="hidden" animate={inView_box_3 ? "visible" : "hidden"} variants={fadeInRight} className="flex flex-col gap-1 md:gap-3 border-2 rounded-3xl shadow-md bg-[url('/images/cognitive-layer-3.png')] bg-no-repeat bg-left-bottom
              px-4 lg:px-8 xl:px-10 pt-8 pb-12 lg:pb-16 xl:pb-20">
              <h3 className={`font-semibold ${anta.className}
              text-2xl md:text-3xl lg:text-4xl tracking-wide`}>LAYER 3: THE SCHOLAR BRAIN</h3>
              <p className={`${anta.className}
              text-xl md:text-2xl lg:text-3xl tracking-tight`}>(Validated Learning)</p>
              <div className='flex flex-col gap-4
              text-base md:text-lg lg:text-xl'>
          ...
          <div id="cognitive_layer_4" className='relative flex gap-4 items-center'>

            <motion.div ref={ref_box_4} initial="hidden" animate={inView_box_4 ? "visible" : "hidden"} variants={fadeInRight} className="flex flex-col gap-1 md:gap-3 border-2 rounded-3xl shadow-md bg-[url('/images/cognitive-layer-4.png')] bg-no-repeat bg-left-bottom
              px-4 lg:px-8 xl:px-10 pt-8 pb-12 lg:pb-16 xl:pb-20">
              <h3 className={`font-semibold ${anta.className}
              text-2xl md:text-3xl lg:text-4xl tracking-wide`}>LAYER 4: THE DETECTIVE BRAIN</h3>
              <p className={`${anta.className}
              text-xl md:text-2xl lg:text-3xl tracking-tight`}>(Deep Connection Analysis)</p>
              <div className='flex flex-col gap-4
              text-base md:text-lg lg:text-xl'>
            ...
            <div className='absolute right-0 w-[30px] -top-[10%] h-[124%] border-b-2 border-r-2 rounded-br-2xl hidden md:block' />
          </div>
        </div>
      </div>
