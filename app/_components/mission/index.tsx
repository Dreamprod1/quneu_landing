...
const MissionIcon = () => (
  <svg className="scale-[0.75]" width="151" height="75" viewBox="0 0 151 75" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const MissionSection = () => {
  ...
  return (
    <div id="mission_section" className="bg-[#0E0E0E] flex flex-col   overflow-hidden  
        pb-7 pt-12 md:pt-16">
      <div className="w-full max-w-[84rem] px-6 mx-auto" ref={ref}>
        <motion.div
          className="flex flex-col items-stretch
            xl:flex-row
            gap-5 md:gap-8 lg:gap-12 xl:gap-16"
          initial="hidden"
        ...
        >
          <motion.div className="flex flex-col flex-1" variants={itemVariants}>
            ...
            text-lg md:text-2xl lg:text-3xl xl:text-4xl `}>OUR VISION</h3>
            <div className="border rounded-2xl flex-1  bg-[url('/images/mission-box-bg-1.png')] bg-right-bottom bg-cover bg-no-repeat
            mt-3 md:mt-5  
            p-6 md:p-9 
            pb-9 md:pb-11 lg:pb-12 xl:pb-16 
            ">
              <p className="text-white 
              text-base md:text-lg lg:text-xl ">To create a world where every organization has autonomous intelligence that grows smarter every day—transforming business complexity into competitive advantage, accelerating human discovery across all industries, and establishing the foundation for truly intelligent enterprises that think, learn, and innovate at the speed of possibility</p>
            </div>
          </motion.div>
          <motion.div className="flex flex-col flex-1" variants={itemVariants}>
            <div className="flex flex-col items-center">
            ...
            <h3 className={`${anta.className} text-white text-center
            text-lg md:text-2xl lg:text-3xl xl:text-4xl `}>OUR MISSION</h3>
            <div className="border rounded-2xl flex-1  bg-[url('/images/mission-box-bg-2.png')] bg-right-bottom bg-cover bg-no-repeat
            mt-3 md:mt-5  
            p-6 md:p-9 
            pb-9 md:pb-11 lg:pb-12 xl:pb-16 ">
              <p className="text-white 
              text-base md:text-lg lg:text-xl ">QUNEU transforms enterprise complexity into intelligence by creating dynamic knowledge graphs that turn vast, disparate data into actionable insights—empowering organizations to make faster decisions, unlock hidden opportunities, and build resilient futures through secure, cost-efficient AI platforms</p>
            </div>
          </motion.div>
          <motion.div className="flex flex-col flex-1" variants={itemVariants}>
            <div className="flex flex-col items-center">
