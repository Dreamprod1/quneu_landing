  ...
  return (
    <div className="relative bg-[#0E0E0E] h-full flex flex-col pt-16 md:pt-24 pb-10">
      <div className="flex justify-end items-end">
        <h2 className={`${anta.className} text-5xl md:text-7xl lg:text-9xl`}>USE CASES</h2>
        ...
        <Carousel>
          <CarouselContent className="px-6 md:px-12">
            <CarouselItem className="basis-full md:basis-1/2 lg:basis-1/3 min-h-[300px] md:min-h-[400px]">
              <div className="border rounded-2xl flex h-full flex-col items-center justify-center p-4 md:p-6 bg-[url('/images/case-box-bg-1.png')] bg-no-repeat bg-center bg-cover">
            ...
            <CarouselItem className="basis-full md:basis-1/2 lg:basis-1/3 min-h-[300px] md:min-h-[400px]">
              <div className="border rounded-2xl flex h-full flex-col items-center justify-center p-4 md:p-6 bg-[url('/images/case-box-bg-2.png')] bg-no-repeat bg-center bg-cover">
            ...
            <CarouselItem className="basis-full md:basis-1/2 lg:basis-1/3 min-h-[300px] md:min-h-[400px]">
              <div className="border rounded-2xl flex h-full flex-col items-center justify-center p-4 md:p-6 bg-[url('/images/case-box-bg-3.png')] bg-no-repeat bg-center bg-cover">
            ...
            <CarouselItem className="basis-full md:basis-1/2 lg:basis-1/3 min-h-[300px] md:min-h-[400px]">
              <div className="border rounded-2xl flex h-full flex-col items-center justify-center p-4 md:p-6 bg-[url('/images/case-box-bg-4.png')] bg-no-repeat bg-center bg-cover">
            ...
            <CarouselItem className="basis-full md:basis-1/2 lg:basis-1/3 min-h-[300px] md:min-h-[400px]">
              <div className="border rounded-2xl flex h-full flex-col items-center justify-center p-4 md:p-6 bg-[url('/images/case-box-bg-5.png')] bg-no-repeat bg-center bg-cover">
